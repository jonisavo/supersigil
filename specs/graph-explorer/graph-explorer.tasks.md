...
```supersigil-xml
<Task id="task-1" status="draft" implements="graph-explorer/req#req-1-1, graph-explorer/req#req-1-5">
...
<Task id="task-2" status="draft" depends="task-1" implements="graph-explorer/req#req-1-2, graph-explorer/req#req-1-3, graph-explorer/req#req-1-4">
...
<Task id="task-3" status="draft" depends="task-2">
...
<Task id="task-4" status="draft" depends="task-3" implements="graph-explorer/req#req-4-1, graph-explorer/req#req-4-2, graph-explorer/req#req-4-3">
...
<Task id="task-5" status="draft" depends="task-4" implements="graph-explorer/req#req-10-1, graph-explorer/req#req-10-2">
...
<Task id="task-6" status="draft" depends="task-4" implements="graph-explorer/req#req-4-4">
...
<Task id="task-7" status="draft" depends="task-4" implements="graph-explorer/req#req-5-1, graph-explorer/req#req-5-2">
...
<Task id="task-8" status="draft" depends="task-4" implements="graph-explorer/req#req-6-1, graph-explorer/req#req-6-2, graph-explorer/req#req-6-3">
...
<Task id="task-9" status="draft" depends="task-4" implements="graph-explorer/req#req-7-1, graph-explorer/req#req-7-2">
...
<Task id="task-10" status="draft" depends="task-4" implements="graph-explorer/req#req-8-1, graph-explorer/req#req-8-2">
...
<Task id="task-11" status="draft" depends="task-7, task-8, task-9, task-10" implements="graph-explorer/req#req-9-1, graph-explorer/req#req-9-2">
...
<Task id="task-12" status="draft" depends="task-5, task-6, task-7, task-8, task-9, task-10, task-11" implements="graph-explorer/req#req-3-1, graph-explorer/req#req-3-2">
...
<Task id="task-13" status="draft" depends="task-2, task-12" implements="graph-explorer/req#req-2-1, graph-explorer/req#req-2-2">
