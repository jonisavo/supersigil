...
<Task id="task-2" status="done" depends="task-1">
  ...
  <Task id="task-2-1" status="done" implements="req/parser-and-config#req-4-1, req/parser-and-config#req-4-5, req/parser-and-config#req-8-3, req/parser-and-config#req-8-4, req/parser-and-config#req-10-1, req/parser-and-config#req-10-2">
  ...
  <Task id="task-2-2" status="done" depends="task-2-1" implements="req/parser-and-config#req-4-1, req/parser-and-config#req-4-5, req/parser-and-config#req-8-2, req/parser-and-config#req-8-3, req/parser-and-config#req-8-4, req/parser-and-config#req-10-1, req/parser-and-config#req-10-2">
  ...
  <Task id="task-2-3" status="done" depends="task-2-2" implements="req/parser-and-config#req-22-1, req/parser-and-config#req-4-1">
...
<Task id="task-3" status="done" depends="task-2">
  ...
  <Task id="task-3-1" status="done" implements="req/parser-and-config#req-11-1, req/parser-and-config#req-11-3, req/parser-and-config#req-12-1, req/parser-and-config#req-12-2, req/parser-and-config#req-12-6, req/parser-and-config#req-12-7, req/parser-and-config#req-13-1, req/parser-and-config#req-13-2, req/parser-and-config#req-13-3, req/parser-and-config#req-13-4, req/parser-and-config#req-14-1, req/parser-and-config#req-14-2, req/parser-and-config#req-14-3, req/parser-and-config#req-15-1, req/parser-and-config#req-15-2, req/parser-and-config#req-16-1, req/parser-and-config#req-16-2, req/parser-and-config#req-16-3, req/parser-and-config#req-17-1, req/parser-and-config#req-17-2, req/parser-and-config#req-17-3, req/parser-and-config#req-17-4, req/parser-and-config#req-18-1, req/parser-and-config#req-18-2, req/parser-and-config#req-19-1, req/parser-and-config#req-19-2, req/parser-and-config#req-19-3, req/parser-and-config#req-19-4, req/parser-and-config#req-19-5, req/parser-and-config#req-24-1">
  ...
  <Task id="task-3-2" status="done" depends="task-3-1" implements="req/parser-and-config#req-11-1, req/parser-and-config#req-13-1, req/parser-and-config#req-14-1, req/parser-and-config#req-15-1, req/parser-and-config#req-16-1, req/parser-and-config#req-17-1, req/parser-and-config#req-18-1, req/parser-and-config#req-19-1">
  ...
  <Task id="task-3-3" status="done" depends="task-3-2" implements="req/parser-and-config#req-23-1, req/parser-and-config#req-11-1">
...
<Task id="task-4" status="done" depends="task-3">
  ...
  <Task id="task-4-1" status="done" implements="req/parser-and-config#req-7-1, req/parser-and-config#req-7-3, req/parser-and-config#req-14-4, req/parser-and-config#req-14-5">
  ...
  <Task id="task-4-2" status="done" depends="task-4-1" implements="req/parser-and-config#req-7-3, req/parser-and-config#req-14-4, req/parser-and-config#req-14-5">
  ...
  <Task id="task-4-3" status="done" depends="task-4-2" implements="req/parser-and-config#req-14-5">
...
<Task id="task-5" status="done" depends="task-4">
  ...
  <Task id="task-5-1" status="done" implements="req/parser-and-config#req-12-3, req/parser-and-config#req-12-4, req/parser-and-config#req-12-5, req/parser-and-config#req-15-3, req/parser-and-config#req-15-4, req/parser-and-config#req-20-1, req/parser-and-config#req-20-2, req/parser-and-config#req-20-3, req/parser-and-config#req-11-2">
  ...
  <Task id="task-5-2" status="done" depends="task-5-1" implements="req/parser-and-config#req-11-1, req/parser-and-config#req-11-2, req/parser-and-config#req-11-3, req/parser-and-config#req-12-1, req/parser-and-config#req-12-2, req/parser-and-config#req-12-3, req/parser-and-config#req-12-4, req/parser-and-config#req-12-5, req/parser-and-config#req-15-3, req/parser-and-config#req-20-1, req/parser-and-config#req-20-2">
  ...
  <Task id="task-5-3" status="done" depends="task-5-2" implements="req/parser-and-config#req-11-3">
  ...
  <Task id="task-5-4" status="done" depends="task-5-3" implements="req/parser-and-config#req-12-1, req/parser-and-config#req-12-2, req/parser-and-config#req-12-3, req/parser-and-config#req-12-4, req/parser-and-config#req-12-5">
  ...
  <Task id="task-5-5" status="done" depends="task-5-4" implements="req/parser-and-config#req-15-3">
  ...
  <Task id="task-5-6" status="done" depends="task-5-5" implements="req/parser-and-config#req-20-1, req/parser-and-config#req-20-2">
...
<Task id="task-6" status="done" depends="task-5">
  ...
  <Task id="task-6-1" status="done" implements="req/parser-and-config#req-7-2">
  ...
  <Task id="task-6-2" status="done" depends="task-6-1" implements="req/parser-and-config#req-7-2">
    Implement `split_list_attribute(raw: &str) -> Result<Vec<&str>, ListSplitError>`

    - Split on `,`, trim each item, reject empty items
  </Task>

  <Task id="task-6-3" status="done" depends="task-6-2" implements="req/parser-and-config#req-7-2">
...
<Task id="task-8" status="in-progress" depends="task-7">
  ...
  <Task id="task-8-1" status="done" implements="req/parser-and-config#req-1-1, req/parser-and-config#req-1-2, req/parser-and-config#req-1-3, req/parser-and-config#req-2-1, req/parser-and-config#req-2-2">
  ...
  <Task id="task-8-2" status="done" depends="task-8-1" implements="req/parser-and-config#req-1-1, req/parser-and-config#req-1-2, req/parser-and-config#req-1-3, req/parser-and-config#req-2-1, req/parser-and-config#req-2-2">
  ...
  <Task id="task-8-3" status="done" depends="task-8-2" implements="req/parser-and-config#req-1-1, req/parser-and-config#req-1-2, req/parser-and-config#req-1-3">
  ...
  <Task id="task-8-4" status="done" depends="task-8-3" implements="req/parser-and-config#req-2-1, req/parser-and-config#req-2-2">
...
<Task id="task-9" status="done" depends="task-8">
  ...
  <Task id="task-9-1" status="done" implements="req/parser-and-config#req-3-1, req/parser-and-config#req-3-2, req/parser-and-config#req-3-3">
  ...
  <Task id="task-9-2" status="done" depends="task-9-1" implements="req/parser-and-config#req-4-1, req/parser-and-config#req-4-2, req/parser-and-config#req-4-3, req/parser-and-config#req-4-4, req/parser-and-config#req-4-5, req/parser-and-config#req-4-6">
  ...
  <Task id="task-9-3" status="done" depends="task-9-2" implements="req/parser-and-config#req-3-1, req/parser-and-config#req-3-2, req/parser-and-config#req-3-3">
  ...
  <Task id="task-9-4" status="done" depends="task-9-3" implements="req/parser-and-config#req-4-1, req/parser-and-config#req-4-2, req/parser-and-config#req-4-3, req/parser-and-config#req-4-4, req/parser-and-config#req-4-5, req/parser-and-config#req-4-6">
  ...
  <Task id="task-9-5" status="done" depends="task-9-4" implements="req/parser-and-config#req-3-3, req/parser-and-config#req-4-6, req/parser-and-config#req-10-2">
  ...
  <Task id="task-9-6" status="done" depends="task-9-5" implements="req/parser-and-config#req-3-2">
  ...
  <Task id="task-9-7" status="done" depends="task-9-6" implements="req/parser-and-config#req-4-4">
...
<Task id="task-10" status="done" depends="task-9">
  ...
  <Task id="task-10-1" status="done" implements="req/parser-and-config#req-5-1, req/parser-and-config#req-5-2">
  ...
  <Task id="task-10-2" status="done" depends="task-10-1" implements="req/parser-and-config#req-5-1, req/parser-and-config#req-5-2">
...
<Task id="task-11" status="done" depends="task-10">
  ...
  <Task id="task-11-1" status="done" implements="req/parser-and-config#req-6-1, req/parser-and-config#req-6-2, req/parser-and-config#req-6-3, req/parser-and-config#req-6-4, req/parser-and-config#req-8-1, req/parser-and-config#req-8-2, req/parser-and-config#req-8-3, req/parser-and-config#req-8-4, req/parser-and-config#req-8-5, req/parser-and-config#req-8-6, req/parser-and-config#req-9-1, req/parser-and-config#req-9-2, req/parser-and-config#req-9-3">
  ...
  <Task id="task-11-2" status="done" depends="task-11-1" implements="req/parser-and-config#req-6-1, req/parser-and-config#req-6-2, req/parser-and-config#req-6-3, req/parser-and-config#req-6-4, req/parser-and-config#req-8-1, req/parser-and-config#req-8-2, req/parser-and-config#req-8-3, req/parser-and-config#req-8-4, req/parser-and-config#req-8-5, req/parser-and-config#req-8-6, req/parser-and-config#req-9-1, req/parser-and-config#req-9-2, req/parser-and-config#req-9-3">
  ...
  <Task id="task-11-3" status="done" depends="task-11-2" implements="req/parser-and-config#req-6-1, req/parser-and-config#req-6-4">
  ...
  <Task id="task-11-4" status="done" depends="task-11-3" implements="req/parser-and-config#req-8-3, req/parser-and-config#req-8-4, req/parser-and-config#req-8-5">
  ...
  <Task id="task-11-5" status="done" depends="task-11-4" implements="req/parser-and-config#req-9-1, req/parser-and-config#req-9-2, req/parser-and-config#req-9-3">
...
<Task id="task-12" status="done" depends="task-11">
  ...
  <Task id="task-12-1" status="done" implements="req/parser-and-config#req-21-1, req/parser-and-config#req-21-2, req/parser-and-config#req-21-3, req/parser-and-config#req-25-1, req/parser-and-config#req-25-2">
  ...
  <Task id="task-12-2" status="done" depends="task-12-1" implements="req/parser-and-config#req-10-1, req/parser-and-config#req-10-2, req/parser-and-config#req-10-3, req/parser-and-config#req-21-4, req/parser-and-config#req-25-3">
  ...
  <Task id="task-12-3" status="done" depends="task-12-2" implements="req/parser-and-config#req-21-1, req/parser-and-config#req-21-2, req/parser-and-config#req-21-3, req/parser-and-config#req-25-1, req/parser-and-config#req-25-2">
  ...
  <Task id="task-12-4" status="done" depends="task-12-3" implements="req/parser-and-config#req-10-1, req/parser-and-config#req-10-2, req/parser-and-config#req-10-3">
  ...
  <Task id="task-12-5" status="done" depends="task-12-4" implements="req/parser-and-config#req-21-1, req/parser-and-config#req-21-2">
  ...
  <Task id="task-12-6" status="done" depends="task-12-5" implements="req/parser-and-config#req-25-1">
  ...
  <Task id="task-12-7" status="done" depends="task-12-6" implements="req/parser-and-config#req-10-3">
...
<Task id="task-14" status="done" depends="task-13">
  ...
  <Task id="task-14-1" status="done" implements="req/parser-and-config#req-3-1, req/parser-and-config#req-3-3, req/parser-and-config#req-4-4, req/parser-and-config#req-4-6, req/parser-and-config#req-9-1">
  ...
  <Task id="task-14-2" status="done" depends="task-14-1" implements="req/parser-and-config#req-10-1, req/parser-and-config#req-10-2, req/parser-and-config#req-22-1">
