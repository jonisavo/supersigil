...
<Task id="task-1" status="done">
  Set up workspace structure and crate scaffolding
...
<Task id="task-2" status="done" depends="task-1">
  Implement `supersigil-core` data model types

  <Task id="task-2-1" status="done" implements="parser-and-config/req#req-4-1, parser-and-config/req#req-4-5, parser-and-config/req#req-8-3, parser-and-config/req#req-8-4, parser-and-config/req#req-10-1, parser-and-config/req#req-10-2">
    Write unit tests for data model types (TDD)
  ...
  <Task id="task-2-2" status="done" depends="task-2-1" implements="parser-and-config/req#req-4-1, parser-and-config/req#req-4-5, parser-and-config/req#req-8-2, parser-and-config/req#req-8-3, parser-and-config/req#req-8-4, parser-and-config/req#req-10-1, parser-and-config/req#req-10-2">
  ...
  <Task id="task-2-3" status="done" depends="task-2-2" implements="parser-and-config/req#req-22-1, parser-and-config/req#req-4-1">
    Write property test: Frontmatter YAML round-trip (Property 1)
...
<Task id="task-3" status="done" depends="task-2">
  Implement Config types and deserialization

  <Task id="task-3-1" status="done" implements="parser-and-config/req#req-11-1, parser-and-config/req#req-11-3, parser-and-config/req#req-12-1, parser-and-config/req#req-12-2, parser-and-config/req#req-12-6, parser-and-config/req#req-12-7, parser-and-config/req#req-13-1, parser-and-config/req#req-13-2, parser-and-config/req#req-13-3, parser-and-config/req#req-13-4, parser-and-config/req#req-14-1, parser-and-config/req#req-14-2, parser-and-config/req#req-14-3, parser-and-config/req#req-15-1, parser-and-config/req#req-15-2, parser-and-config/req#req-16-1, parser-and-config/req#req-16-2, parser-and-config/req#req-16-3, parser-and-config/req#req-17-1, parser-and-config/req#req-17-2, parser-and-config/req#req-17-3, parser-and-config/req#req-17-4, parser-and-config/req#req-18-1, parser-and-config/req#req-18-2, parser-and-config/req#req-19-1, parser-and-config/req#req-19-2, parser-and-config/req#req-19-3, parser-and-config/req#req-19-4, parser-and-config/req#req-19-5, parser-and-config/req#req-24-1">
    Write unit tests for Config types (TDD)
  ...
  <Task id="task-3-2" status="done" depends="task-3-1" implements="parser-and-config/req#req-11-1, parser-and-config/req#req-13-1, parser-and-config/req#req-14-1, parser-and-config/req#req-15-1, parser-and-config/req#req-16-1, parser-and-config/req#req-17-1, parser-and-config/req#req-18-1, parser-and-config/req#req-19-1">
    Implement Config and all supporting types
  ...
  <Task id="task-3-3" status="done" depends="task-3-2" implements="parser-and-config/req#req-23-1, parser-and-config/req#req-11-1">
    Write property test: Config TOML round-trip (Property 2)
...
<Task id="task-4" status="done" depends="task-3">
  Implement built-in component definitions and ComponentDefs

  <Task id="task-4-1" status="done" implements="parser-and-config/req#req-7-1, parser-and-config/req#req-7-3, parser-and-config/req#req-14-4, parser-and-config/req#req-14-5">
    Write unit tests for ComponentDefs (TDD)

    - Test `ComponentDefs::defaults()` returns exactly the 8 built-in components (AcceptanceCriteria, Criterion, References, VerifiedBy, Implements, Task, TrackedFiles, DependsOn) with correct attribute schemas
    ...
    - Test list-typed attributes: `refs` on References/Implements/DependsOn, `paths` on VerifiedBy/TrackedFiles, `implements`/`depends` on Task
  </Task>

  <Task id="task-4-2" status="done" depends="task-4-1" implements="parser-and-config/req#req-7-3, parser-and-config/req#req-14-4, parser-and-config/req#req-14-5">
    Implement `ComponentDefs` with `defaults()`, `merge()`, `is_known()`, `get()`
  ...
  <Task id="task-4-3" status="done" depends="task-4-2" implements="parser-and-config/req#req-14-5">
    Write property test: Component definition merge (Property 13)
...
<Task id="task-5" status="done" depends="task-4">
  ...
  <Task id="task-5-1" status="done" implements="parser-and-config/req#req-12-3, parser-and-config/req#req-12-4, parser-and-config/req#req-12-5, parser-and-config/req#req-15-3, parser-and-config/req#req-15-4, parser-and-config/req#req-20-1, parser-and-config/req#req-20-2, parser-and-config/req#req-20-3, parser-and-config/req#req-11-2">
    Write unit tests for `load_config` validation (TDD)
  ...
  <Task id="task-5-2" status="done" depends="task-5-1" implements="parser-and-config/req#req-11-1, parser-and-config/req#req-11-2, parser-and-config/req#req-11-3, parser-and-config/req#req-12-1, parser-and-config/req#req-12-2, parser-and-config/req#req-12-3, parser-and-config/req#req-12-4, parser-and-config/req#req-12-5, parser-and-config/req#req-15-3, parser-and-config/req#req-20-1, parser-and-config/req#req-20-2">
    Implement `load_config(path) -> Result<Config, Vec<ConfigError>>`
  ...
  <Task id="task-5-3" status="done" depends="task-5-2" implements="parser-and-config/req#req-11-3">
    Write property test: Unknown TOML keys rejected (Property 11)
  ...
  <Task id="task-5-4" status="done" depends="task-5-3" implements="parser-and-config/req#req-12-1, parser-and-config/req#req-12-2, parser-and-config/req#req-12-3, parser-and-config/req#req-12-4, parser-and-config/req#req-12-5">
    Write property test: Mutual exclusivity (Property 12)
  ...
  <Task id="task-5-5" status="done" depends="task-5-4" implements="parser-and-config/req#req-15-3">
    Write property test: Unknown verification rules rejected (Property 14)

    - **Property 14: Unknown verification rule names are rejected**
    - Generate rule names not in the known set, verify error
  </Task>

  <Task id="task-5-6" status="done" depends="task-5-5" implements="parser-and-config/req#req-20-1, parser-and-config/req#req-20-2">
    Write property test: id_pattern regex validation (Property 19)
...
<Task id="task-6" status="done" depends="task-5">
  Implement `split_list_attribute` utility

  <Task id="task-6-1" status="done" implements="parser-and-config/req#req-7-2">
    Write unit tests for `split_list_attribute` (TDD)
  ...
  <Task id="task-6-2" status="done" depends="task-6-1" implements="parser-and-config/req#req-7-2">
    Implement `split_list_attribute(raw: &str) -> Result<Vec<&str>, ListSplitError>`

    - Split on `,`, trim each item, reject empty items
  </Task>

  <Task id="task-6-3" status="done" depends="task-6-2" implements="parser-and-config/req#req-7-2">
    Write property test: List splitting (Property 15)
...
<Task id="task-7" status="done" depends="task-6">
  Checkpoint — `supersigil-core` complete
...
<Task id="task-8" status="in-progress" depends="task-7">
  Implement parser Stage 1: Preprocessing

  <Task id="task-8-1" status="done" implements="parser-and-config/req#req-1-1, parser-and-config/req#req-1-2, parser-and-config/req#req-1-3, parser-and-config/req#req-2-1, parser-and-config/req#req-2-2">
    Write unit tests for preprocessing (TDD)
  ...
  <Task id="task-8-2" status="done" depends="task-8-1" implements="parser-and-config/req#req-1-1, parser-and-config/req#req-1-2, parser-and-config/req#req-1-3, parser-and-config/req#req-2-1, parser-and-config/req#req-2-2">
    Implement `preprocess(raw: &[u8]) -> Result<String, ParseError>`
  ...
  <Task id="task-8-3" status="done" depends="task-8-2" implements="parser-and-config/req#req-1-1, parser-and-config/req#req-1-2, parser-and-config/req#req-1-3">
    Write property test: BOM stripping (Property 3)
  ...
  <Task id="task-8-4" status="done" depends="task-8-3" implements="parser-and-config/req#req-2-1, parser-and-config/req#req-2-2">
    Write property test: CRLF normalization (Property 4)
...
<Task id="task-9" status="done" depends="task-8">
  Implement parser Stage 1: Front matter extraction and deserialization

  <Task id="task-9-1" status="done" implements="parser-and-config/req#req-3-1, parser-and-config/req#req-3-2, parser-and-config/req#req-3-3">
    Write unit tests for front matter extraction (TDD)
  ...
  <Task id="task-9-2" status="done" depends="task-9-1" implements="parser-and-config/req#req-4-1, parser-and-config/req#req-4-2, parser-and-config/req#req-4-3, parser-and-config/req#req-4-4, parser-and-config/req#req-4-5, parser-and-config/req#req-4-6">
    Write unit tests for front matter deserialization (TDD)
  ...
  <Task id="task-9-3" status="done" depends="task-9-2" implements="parser-and-config/req#req-3-1, parser-and-config/req#req-3-2, parser-and-config/req#req-3-3">
    Implement `extract_front_matter(content: &str) -> Result<Option<(&str, &str)>, ParseError>`
  ...
  <Task id="task-9-4" status="done" depends="task-9-3" implements="parser-and-config/req#req-4-1, parser-and-config/req#req-4-2, parser-and-config/req#req-4-3, parser-and-config/req#req-4-4, parser-and-config/req#req-4-5, parser-and-config/req#req-4-6">
    Implement `deserialize_front_matter(yaml: &str) -> Result<FrontMatterResult, ParseError>`
  ...
  <Task id="task-9-5" status="done" depends="task-9-4" implements="parser-and-config/req#req-3-3, parser-and-config/req#req-4-6, parser-and-config/req#req-10-2">
    Write property test: NotSupersigil detection (Property 5)
  ...
  <Task id="task-9-6" status="done" depends="task-9-5" implements="parser-and-config/req#req-3-2">
    Write property test: Unclosed front matter (Property 6)
  ...
  <Task id="task-9-7" status="done" depends="task-9-6" implements="parser-and-config/req#req-4-4">
    Write property test: Extra metadata preservation (Property 7)
...
<Task id="task-10" status="done" depends="task-9">
  Implement parser Stage 2: MDX AST generation

  <Task id="task-10-1" status="done" implements="parser-and-config/req#req-5-1, parser-and-config/req#req-5-2">
    Write unit tests for MDX parsing (TDD)
  ...
  <Task id="task-10-2" status="done" depends="task-10-1" implements="parser-and-config/req#req-5-1, parser-and-config/req#req-5-2">
    Implement `parse_mdx_body(body: &str) -> Result<mdast::Node, ParseError>`
...
<Task id="task-11" status="done" depends="task-10">
  Implement parser Stage 3: Component extraction

  <Task id="task-11-1" status="done" implements="parser-and-config/req#req-6-1, parser-and-config/req#req-6-2, parser-and-config/req#req-6-3, parser-and-config/req#req-6-4, parser-and-config/req#req-8-1, parser-and-config/req#req-8-2, parser-and-config/req#req-8-3, parser-and-config/req#req-8-4, parser-and-config/req#req-8-5, parser-and-config/req#req-8-6, parser-and-config/req#req-9-1, parser-and-config/req#req-9-2, parser-and-config/req#req-9-3">
    Write unit tests for component extraction (TDD)
  ...
  <Task id="task-11-2" status="done" depends="task-11-1" implements="parser-and-config/req#req-6-1, parser-and-config/req#req-6-2, parser-and-config/req#req-6-3, parser-and-config/req#req-6-4, parser-and-config/req#req-8-1, parser-and-config/req#req-8-2, parser-and-config/req#req-8-3, parser-and-config/req#req-8-4, parser-and-config/req#req-8-5, parser-and-config/req#req-8-6, parser-and-config/req#req-9-1, parser-and-config/req#req-9-2, parser-and-config/req#req-9-3">
    Implement `extract_components(node, component_defs, body_offset, errors) -> Vec<ExtractedComponent>`
  ...
  <Task id="task-11-3" status="done" depends="task-11-2" implements="parser-and-config/req#req-6-1, parser-and-config/req#req-6-4">
    Write property test: String attribute fidelity (Property 8)
  ...
  <Task id="task-11-4" status="done" depends="task-11-3" implements="parser-and-config/req#req-8-3, parser-and-config/req#req-8-4, parser-and-config/req#req-8-5">
    Write property test: Body text (Property 9)
  ...
  <Task id="task-11-5" status="done" depends="task-11-4" implements="parser-and-config/req#req-9-1, parser-and-config/req#req-9-2, parser-and-config/req#req-9-3">
    Write property test: Recursive child collection (Property 10)
...
<Task id="task-12" status="done" depends="task-11">
  Implement lint-time validation and `parse_file` public API

  <Task id="task-12-1" status="done" implements="parser-and-config/req#req-21-1, parser-and-config/req#req-21-2, parser-and-config/req#req-21-3, parser-and-config/req#req-25-1, parser-and-config/req#req-25-2">
    Write unit tests for lint-time validation (TDD)
  ...
  <Task id="task-12-2" status="done" depends="task-12-1" implements="parser-and-config/req#req-10-1, parser-and-config/req#req-10-2, parser-and-config/req#req-10-3, parser-and-config/req#req-21-4, parser-and-config/req#req-25-3">
    Write unit tests for `parse_file` integration (TDD)
  ...
  <Task id="task-12-3" status="done" depends="task-12-2" implements="parser-and-config/req#req-21-1, parser-and-config/req#req-21-2, parser-and-config/req#req-21-3, parser-and-config/req#req-25-1, parser-and-config/req#req-25-2">
    Implement lint-time validation checks
  ...
  <Task id="task-12-4" status="done" depends="task-12-3" implements="parser-and-config/req#req-10-1, parser-and-config/req#req-10-2, parser-and-config/req#req-10-3">
    Implement `parse_file(path, &ComponentDefs) -> Result<ParseResult, Vec<ParseError>>`
  ...
  <Task id="task-12-5" status="done" depends="task-12-4" implements="parser-and-config/req#req-21-1, parser-and-config/req#req-21-2">
    Write property test: Missing required attributes detected (Property 16)
  ...
  <Task id="task-12-6" status="done" depends="task-12-5" implements="parser-and-config/req#req-25-1">
    Write property test: Unknown component names detected (Property 17)
  ...
  <Task id="task-12-7" status="done" depends="task-12-6" implements="parser-and-config/req#req-10-3">
    Write property test: Error collection (Property 18)
...
<Task id="task-13" status="done" depends="task-12">
  Checkpoint — `supersigil-parser` complete
...
<Task id="task-14" status="done" depends="task-13">
  Create MDX test fixtures and final integration validation

  <Task id="task-14-1" status="done" implements="parser-and-config/req#req-3-1, parser-and-config/req#req-3-3, parser-and-config/req#req-4-4, parser-and-config/req#req-4-6, parser-and-config/req#req-9-1">
    Create MDX test fixture files
  ...
  <Task id="task-14-2" status="done" depends="task-14-1" implements="parser-and-config/req#req-10-1, parser-and-config/req#req-10-2, parser-and-config/req#req-22-1">
...
<Task id="task-15" status="done" depends="task-14">
  Final checkpoint — all crates complete
