...
- [ ] 1. Set up workspace structure and crate scaffolding
...
- [ ] 2. Implement `supersigil-core` data model types
  - [ ] 2.1 Write unit tests for data model types (TDD)
  ...
  - [ ] 2.2 Implement data model types
  ...
  - [ ] 2.3 Write property test: Frontmatter YAML round-trip (Property 1)
...
- [ ] 3. Implement Config types and deserialization
  - [ ] 3.1 Write unit tests for Config types (TDD)
  ...
  - [ ] 3.2 Implement Config and all supporting types
  ...
  - [ ] 3.3 Write property test: Config TOML round-trip (Property 2)
...
- [ ] 4. Implement built-in component definitions and ComponentDefs
  - [ ] 4.1 Write unit tests for ComponentDefs (TDD)
  ...
  - [ ] 4.2 Implement `ComponentDefs` with `defaults()`, `merge()`, `is_known()`, `get()`
  ...
  - [ ] 4.3 Write property test: Component definition merge (Property 13)
...
- [ ] 5. Implement `load_config` with validation
  - [ ] 5.1 Write unit tests for `load_config` validation (TDD)
  ...
  - [ ] 5.2 Implement `load_config(path) -> Result<Config, Vec<ConfigError>>`
  ...
  - [ ] 5.3 Write property test: Unknown TOML keys rejected (Property 11)
  ...
  - [ ] 5.4 Write property test: Mutual exclusivity (Property 12)
  ...
  - [ ] 5.5 Write property test: Unknown verification rules rejected (Property 14)
    - **Property 14: Unknown verification rule names are rejected**
    - Generate rule names not in the known set, verify error
    - **Validates: Requirements 15.3**

  - [ ] 5.6 Write property test: id_pattern regex validation (Property 19)
...
- [ ] 6. Implement `split_list_attribute` utility
  - [ ] 6.1 Write unit tests for `split_list_attribute` (TDD)
  ...
  - [ ] 6.2 Implement `split_list_attribute(raw: &str) -> Result<Vec<&str>, ListSplitError>`
    - Split on `,`, trim each item, reject empty items
    - _Requirements: 7.2_

  - [ ] 6.3 Write property test: List splitting (Property 15)
...
- [ ] 7. Checkpoint — `supersigil-core` complete
...
- [ ] 8. Implement parser Stage 1: Preprocessing
  - [ ] 8.1 Write unit tests for preprocessing (TDD)
  ...
  - [ ] 8.2 Implement `preprocess(raw: &[u8]) -> Result<String, ParseError>`
    - Decode UTF-8 (return `IoError` on failure)
    - Strip leading BOM (U+FEFF) if present
    - Replace all `\r\n` with `\n`
    - _Requirements: 1.1, 1.2, 1.3, 2.1, 2.2_

  - [ ] 8.3 Write property test: BOM stripping (Property 3)
  ...
  - [ ] 8.4 Write property test: CRLF normalization (Property 4)
    - **Property 4: CRLF normalization eliminates all CRLF sequences**
    - Generate strings with arbitrary `\r\n` placement, verify no `\r\n` in output, bare `\r` preserved
    - **Validates: Requirements 2.1, 2.2**

- [ ] 9. Implement parser Stage 1: Front matter extraction and deserialization
  - [ ] 9.1 Write unit tests for front matter extraction (TDD)
  ...
  - [ ] 9.2 Write unit tests for front matter deserialization (TDD)
  ...
  - [ ] 9.3 Implement `extract_front_matter(content: &str) -> Result<Option<(&str, &str)>, ParseError>`
  ...
  - [ ] 9.4 Implement `deserialize_front_matter(yaml: &str) -> Result<FrontMatterResult, ParseError>`
  ...
  - [ ] 9.5 Write property test: NotSupersigil detection (Property 5)
  ...
  - [ ] 9.6 Write property test: Unclosed front matter (Property 6)
  ...
  - [ ] 9.7 Write property test: Extra metadata preservation (Property 7)
...
- [ ] 10. Implement parser Stage 2: MDX AST generation
  - [ ] 10.1 Write unit tests for MDX parsing (TDD)
  ...
  - [ ] 10.2 Implement `parse_mdx_body(body: &str) -> Result<mdast::Node, ParseError>`
    - Use `markdown-rs` with MDX constructs enabled
    - Map parse errors to `MdxSyntaxError`
    - _Requirements: 5.1, 5.2_

- [ ] 11. Implement parser Stage 3: Component extraction
  - [ ] 11.1 Write unit tests for component extraction (TDD)
  ...
  - [ ] 11.2 Implement `extract_components(node, component_defs, body_offset, errors) -> Vec<ExtractedComponent>`
  ...
  - [ ] 11.3 Write property test: String attribute fidelity (Property 8)
  ...
  - [ ] 11.4 Write property test: Body text (Property 9)
  ...
  - [ ] 11.5 Write property test: Recursive child collection (Property 10)
...
- [ ] 12. Implement lint-time validation and `parse_file` public API
  - [ ] 12.1 Write unit tests for lint-time validation (TDD)
  ...
  - [ ] 12.2 Write unit tests for `parse_file` integration (TDD)
  ...
  - [ ] 12.3 Implement lint-time validation checks
  ...
  - [ ] 12.4 Implement `parse_file(path, &ComponentDefs) -> Result<ParseResult, Vec<ParseError>>`
  ...
  - [ ] 12.5 Write property test: Missing required attributes detected (Property 16)
  ...
  - [ ] 12.6 Write property test: Unknown component names detected (Property 17)
  ...
  - [ ] 12.7 Write property test: Error collection (Property 18)
...
- [ ] 13. Checkpoint — `supersigil-parser` complete
...
- [ ] 14. Create MDX test fixtures and final integration validation
  - [ ] 14.1 Create MDX test fixture files
  ...
  - [ ] 14.2 Write fixture-based integration tests
...
- [ ] 15. Final checkpoint — all crates complete
