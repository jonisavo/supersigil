...
Custom components participate in structural checking (known component names, required attributes) but do not create graph edges unless configured via hooks.
...
External commands that run after verification:
