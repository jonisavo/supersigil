...
Components are MDX JSX elements that carry specification semantics. Supersigil has 10 built-in components. Each component is validated during lint and becomes a typed node in the specification graph.
