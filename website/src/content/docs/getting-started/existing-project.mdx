...
1. **Initialize Supersigil**
   ...
   This creates `supersigil.toml` and installs agent skills. See the [Quickstart](/supersigil/getting-started/#install) for install options and the [CLI reference](/supersigil/reference/cli/#supersigil-init) for all `init` flags.
