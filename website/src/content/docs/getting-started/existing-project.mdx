...
Use `supersigil verify --since main` in pull request checks to keep full verification while adding affected-document context from tracked file changes. See the [CI Verification guide](/guides/ci-verification/) for the full setup.
