...
Decisions also benefit from transitive affected-doc propagation: if a Decision references a document via `<References>`, and that document's tracked files change, the Decision's document is flagged as transitively affected.
...
- [Components Reference](/reference/components/) — Full attribute tables for Decision, Rationale, and Alternative.
- [Verification](/concepts/verification/) — Rule severities, draft gating, and configuration.
- [The Component Graph](/concepts/component-graph/) — How decisions participate in the specification graph.
