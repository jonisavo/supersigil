...
- **`refactoring`** — Restructure code while keeping specs, criteria, and verification evidence valid.
- **`ci-review`** — Integrate Supersigil verification into CI pipelines and PR review workflows.
