...
`supersigil verify` performs whole-graph analysis: structural checks, cross-document references, coverage, test mappings, affected-document hints, and cycles. This is the CI command.
...
<CardGrid>
  <Card title="The Component Graph" icon="random">
    ...
    [Read more](/concepts/component-graph/)
  </Card>
  <Card title="Verification" icon="approve-check">
    ...
    [Read more](/concepts/verification/)
  </Card>
  <Card title="Evidence Sources" icon="magnifier">
    ...
    [Read more](/concepts/evidence-sources/)
  </Card>
  <Card title="Architecture Decisions" icon="document">
    ...
    [Read more](/concepts/architecture-decisions/)
  </Card>
</CardGrid>
