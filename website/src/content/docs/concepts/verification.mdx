...
When tracked files change, `supersigil verify --since <ref>` reports the associated specs as affected. Human-readable output points to the dedicated query, and JSON includes a compact `affected_summary`:
