//! Plugin evidence presentation helpers for the CLI.
//!
//! The actual plugin assembly and evidence orchestration logic lives in
//! `supersigil_verify::plugins`. This module provides CLI-specific formatting.
...
mod tests {
    ...
    use supersigil_core::{Config, DocumentGraph, EcosystemConfig};
    ...
    use supersigil_verify::{RuleName, assemble_plugins, collect_plugin_evidence};
